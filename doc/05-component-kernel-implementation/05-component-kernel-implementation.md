...
I will choose the Map representation because the Tracker component involves
pairs of names with thier values. Each Map.Pair will have the statistic name
as the key and corresponding value as its value.
