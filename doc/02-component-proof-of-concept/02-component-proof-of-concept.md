...
I will pick the tracker for this assignment. I would like to implement a more
challanging component, but I want to have the proof of concept for a simpler
design in case it does not work out.
